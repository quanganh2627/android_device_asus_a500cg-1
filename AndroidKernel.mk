...
KERNEL_OUT_MODINSTALL := $(PRODUCT_OUT)/obj/$(KERNEL_MODINSTALL)
KERNEL_OUT_HDRINSTALL := $(PRODUCT_OUT)/obj/KERNEL_OBJ/usr
...
KERNEL_BLD_FLAGS := \
    ARCH=$(KERNEL_ARCH) \
    INSTALL_MOD_PATH=$(KERNEL_OUT_MODINSTALL) \
    INSTALL_MOD_STRIP=1 \
    INSTALL_HDR_PATH=$(KERNEL_OUT_HDRINSTALL) \
...
KERNEL_DEFCONFIG := $(KERNEL_SRC_DIR)/arch/x86/configs/$(TARGET_KERNEL_CONFIG)
endif
...
copy_modules_to_root: $(KERNEL_BZIMAGE) modules_install headers_install
