...
struct IModemAudioManagerInterface : public NInterfaceProvider::IInterface
{
    ...
    virtual void setModemAudioManagerObserver(IModemAudioManagerObserver* pModemAudioManagerObserver) = 0;
    virtual bool isModemAlive() = 0;
    virtual bool isModemAudioAvailable() = 0;
